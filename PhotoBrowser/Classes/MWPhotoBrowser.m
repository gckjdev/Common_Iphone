...
//    self.navigationController.navigationBar.barStyle = UIBarStyleBlackTranslucent;
    ...
    if (photos.count > 0) {
        ...
        // Toolbar Items
        doneButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(goBack)];
...
- (void)goBack { [self dismissModalViewControllerAnimated:YES]; }
