...
#ifndef Download_DownloadNetworkConstants_h
#define Download_DownloadNetworkConstants_h
...
#define METHOD_FINDTOPDOWNLOAD @"ftdl"
...
#define PARA_URL @"url"
#define PARA_RANK @"rk"
#define PARA_SCORE @"sc"
#define PARA_CREATE_DATE @"cd"
#define PARA_MODIFY_DATE @"md"
#define PARA_TYPE @"tp"
